Vue.createApp({
    data: function () {
        return {editingQuiz: false, currentQuiz: {}, currentPage: "loading", user: {name: "", email: "", password: ""}, currentUser: null, newQuiz: {title: "", description: "", questions: []}, newQuestions: [{questionText: "", possibleChoices: [{answerText: "", isCorrect: false}]}], quizzes: [], currentQuizQuestion: 0, currentQuizQuestionAnswered: false, currentQuizTotalScore: 0};
    },
    methods: {
